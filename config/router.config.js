    ...
    routes: [
      ...
      },
      {
        ...
        routes:[
          ...
          {
            path: '/pages-management/create-pages',
            name: 'createPages',
            component: './PagesManagement/ActivityModels/CreatePages/CreatePages',
          },
          {
            path: '/pages-management/a-type-model/:id?',
            name: 'aTypeModel',
            hideInMenu:true,
            component: './PagesManagement/ActivityModels/ATypeModel/ATypeModel',
          },
          {
            path: '/pages-management/b-type-model',
            name: 'bTypeModel',
            hideInMenu:true,
            component: './PagesManagement/ActivityModels/BTypeModel/BTypeModel',
          },
        ]
      },
      {
